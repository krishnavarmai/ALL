...
namespace Nop.Core.Domain.Customers
{
    ...
    public partial class Customer : BaseEntity
    {
        ...
        protected ICollection<CustomerBillToMapping> _CustomerBillToMappings;
        ...
        public IList<BillTo> BillTos => CustomerBillToMappings.Select(mapping => mapping.BillTo).ToList();
        //public virtual IList<ShipTo> ShipTos => CustomerBillToMappings.Select(mapping => mapping.ShipTo).ToList();
        ...
        public virtual ICollection<CustomerBillToMapping> CustomerBillToMappings
        {
            get => _CustomerBillToMappings ?? (_CustomerBillToMappings = new List<CustomerBillToMapping>());
            protected set => _CustomerBillToMappings = value;
        }
