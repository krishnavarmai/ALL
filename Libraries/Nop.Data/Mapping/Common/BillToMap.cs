...
namespace Nop.Data.Mapping.Common
{
    ...
    /// </summary>
    public partial class BillToMap : NopEntityTypeConfiguration<BillTo>
    {
        #region Methods
        ...
        public override void Configure(EntityTypeBuilder<BillTo> builder)
        {
            builder.ToTable(nameof(BillTo));
