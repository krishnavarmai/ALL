...
namespace Nop.Services.Messages
{
    ...
    public partial class MessageTokenProvider : IMessageTokenProvider
    {
        ...
        public virtual void AddOrderTokens(IList<Token> tokens, Order order, int languageId, int vendorId = 0)
        {
            ...
            tokens.Add(new Token("Order.CustomerFullName", $"{order.BillTo.FirstName} {order.BillTo.LastName}"));
            tokens.Add(new Token("Order.CustomerEmail", order.BillTo.Email));

            tokens.Add(new Token("Order.BillingFirstName", order.BillTo.FirstName));
            tokens.Add(new Token("Order.BillingLastName", order.BillTo.LastName));
            tokens.Add(new Token("Order.BillingPhoneNumber", order.BillTo.PhoneNumber));
            tokens.Add(new Token("Order.BillingEmail", order.BillTo.Email));
            tokens.Add(new Token("Order.BillingFaxNumber", order.BillTo.FaxNumber));
            tokens.Add(new Token("Order.BillingCompany", order.BillTo.Company));
            tokens.Add(new Token("Order.BillingAddress1", order.BillTo.Address1));
            tokens.Add(new Token("Order.BillingAddress2", order.BillTo.Address2));
            tokens.Add(new Token("Order.BillingCity", order.BillTo.City));
            tokens.Add(new Token("Order.BillingCounty", order.BillTo.County));
            tokens.Add(new Token("Order.BillingStateProvince", order.BillTo.StateProvince != null ? _localizationService.GetLocalized(order.BillTo.StateProvince, x => x.Name) : string.Empty));
            tokens.Add(new Token("Order.BillingZipPostalCode", order.BillTo.ZipPostalCode));
            tokens.Add(new Token("Order.BillingCountry", order.BillTo.Country != null ? _localizationService.GetLocalized(order.BillTo.Country, x => x.Name) : string.Empty));
            tokens.Add(new Token("Order.BillingCustomAttributes", _addressAttributeFormatter.FormatAttributes(order.BillTo.CustomAttributes), true));
            ...
            tokens.Add(new Token("Order.ShippingFirstName", order.ShipTo != null ? order.ShipTo.FirstName : string.Empty));
            tokens.Add(new Token("Order.ShippingLastName", order.ShipTo != null ? order.ShipTo.LastName : string.Empty));
            tokens.Add(new Token("Order.ShippingPhoneNumber", order.ShipTo != null ? order.ShipTo.PhoneNumber : string.Empty));
            tokens.Add(new Token("Order.ShippingEmail", order.ShipTo != null ? order.ShipTo.Email : string.Empty));
            tokens.Add(new Token("Order.ShippingFaxNumber", order.ShipTo != null ? order.ShipTo.FaxNumber : string.Empty));
            tokens.Add(new Token("Order.ShippingCompany", order.ShipTo != null ? order.ShipTo.Company : string.Empty));
            tokens.Add(new Token("Order.ShippingAddress1", order.ShipTo != null ? order.ShipTo.Address1 : string.Empty));
            tokens.Add(new Token("Order.ShippingAddress2", order.ShipTo != null ? order.ShipTo.Address2 : string.Empty));
            tokens.Add(new Token("Order.ShippingCity", order.ShipTo != null ? order.ShipTo.City : string.Empty));
            tokens.Add(new Token("Order.ShippingCounty", order.ShipTo != null ? order.ShipTo.County : string.Empty));
            tokens.Add(new Token("Order.ShippingStateProvince", order.ShipTo?.StateProvince != null ? _localizationService.GetLocalized(order.ShipTo.StateProvince, x => x.Name) : string.Empty));
            tokens.Add(new Token("Order.ShippingZipPostalCode", order.ShipTo != null ? order.ShipTo.ZipPostalCode : string.Empty));
            tokens.Add(new Token("Order.ShippingCountry", order.ShipTo != null && order.ShipTo.Country != null ? _localizationService.GetLocalized(order.ShipTo.Country, x => x.Name) : string.Empty));
            tokens.Add(new Token("Order.ShippingCustomAttributes", _addressAttributeFormatter.FormatAttributes(order.ShipTo != null ? order.ShipTo.CustomAttributes : string.Empty), true));
