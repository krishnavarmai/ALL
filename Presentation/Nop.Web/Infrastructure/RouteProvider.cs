...
namespace Nop.Web.Infrastructure
{
    ...
    public partial class RouteProvider : IRouteProvider
    {
        ...
        public void RegisterRoutes(IRouteBuilder routeBuilder)
        {
            ...
            routeBuilder.MapLocalizedRoute("ChangeBillTo", "changeBillTo/{BillToId:min(0)}",
                new { controller = "Common", action = "SetBillTo" });

            routeBuilder.MapLocalizedRoute("ChangeShipTo", "changeShipTo/{ShipToId:min(0)}",
                new { controller = "Common", action = "SetShipTo" });
