...
namespace Nop.Web.Controllers
{
    public partial class ShoppingCartController : BasePublicController
    {
        ...
        [HttpPost]
        public virtual IActionResult AddProductNameToCart_Catalog(string productName, int shoppingCartTypeId,
           int quantity, bool forceredirection = false)
        {
            var cartType = (ShoppingCartType)shoppingCartTypeId;

            var product = _productService.GetProductBySku(productName);
            if (product == null)
                //no product found
                return Json(new
                {
